     ...
     for(uint8_t i = 0; i < IPF; i++){
          ...
          */
          switch(OP & 0xF000){
               ...
               case 0xE000:
                    switch(NN){
                         case 0x9E: if(C8->KEY_PRESS[C8->V[X] & 0xF] == 1)C8->PC += 2;
                                      break;
                         case 0xA1: if(C8->KEY_PRESS[C8->V[X] & 0xF] == 0)C8->PC += 2;
                                      break;
                    }
                    break;
               case 0xF000:
...
void KEYBOARD(CHIP_8 *C8){
     ...
     if(!_kbhit() && C8->KEY_PRESS[0x0] == 1 || C8->KEY_PRESS[0x1] == 1 || C8->KEY_PRESS[0x2] == 1 ||
                     C8->KEY_PRESS[0x3] == 1 || C8->KEY_PRESS[0x4] == 1 || C8->KEY_PRESS[0x5] == 1 ||
                     C8->KEY_PRESS[0x6] == 1 || C8->KEY_PRESS[0x7] == 1 || C8->KEY_PRESS[0x8] == 1 ||
                     C8->KEY_PRESS[0x9] == 1 || C8->KEY_PRESS[0xA] == 1 || C8->KEY_PRESS[0xB] == 1 ||
                     C8->KEY_PRESS[0xC] == 1 || C8->KEY_PRESS[0xD] == 1 || C8->KEY_PRESS[0xE] == 1 ||
                     C8->KEY_PRESS[0xF] == 1)for(uint8_t i = 0; i < 16; i++)C8->KEY_PRESS[i] = 0;
}
